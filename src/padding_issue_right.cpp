...
// GROUPBOX Issue right
padding_issue_right::padding_issue_right(widget widget_a, widget widget_b) :
...
vector<wstring> padding_issue_right::Create_message()
{
	...
	//issue ID
	output_text.push_back(L"  The following controller does not respect the right padding for its groupbox\n");

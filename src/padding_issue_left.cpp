...
// GROUPBOX Issue left
padding_issue_left::padding_issue_left(widget widget_a, widget widget_b) :
...
vector<wstring> padding_issue_left::Create_message()
{
	...
	//issue ID
	output_text.push_back(L"  The following controller does not respect the left padding for its groupbox\n");

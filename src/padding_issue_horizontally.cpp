...
padding_issue_horizontally::padding_issue_horizontally(const widget &widget_a, const widget &widget_b, const int &distance) :
...
vector<wstring> padding_issue_horizontally::Create_message()
{
	...
	//issue ID
	output_text.push_back(L"  The following two controllers have a horizontal padding issue:\n");
	...
	output_text.push_back(L"\tSuggestion: Increase the horizontal distance between them by " + m_distance + L"\n");

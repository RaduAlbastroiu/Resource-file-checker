...
// GROUPBOX Issue bot constructor
padding_issue_bot::padding_issue_bot(widget widget_a, widget widget_b) :
...
vector<wstring> padding_issue_bot::Create_message()
{
	...
	//issue ID
	output_text.push_back(L"  The following controller does not respect the bottom padding for its groupbox\n");
